 ...
 *
 */
export default class CoordinationV1Api extends runtime.BaseAPI {
  /**
   * create a Lease
   */
  async createNamespacedLeaseRaw(
    requestParameters: CreateNamespacedLeaseRequest
  ): Promise<runtime.ApiResponse<V1Lease>> {
  ...
  async watchListLeaseForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1LeaseList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1LeaseList>>(
      {
  ...
  async listLeaseForAllNamespacesRaw(
    requestParameters: ListLeaseForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1LeaseList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
