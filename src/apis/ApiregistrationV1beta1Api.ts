 ...
 *
 */
export default class ApiregistrationV1beta1Api extends runtime.BaseAPI {
  /**
   * create an APIService
   */
  async createAPIServiceRaw(
    requestParameters: CreateAPIServiceRequest
  ): Promise<runtime.ApiResponse<V1beta1APIService>> {
  ...
  async watchListAPIService(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1beta1APIServiceList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1beta1APIServiceList>>(
      {
        path: `/apis/apiregistration.k8s.io/v1beta1/apiservices`,
        method: 'GET',
        headers: headerParameters,
  ...
  async listAPIServiceRaw(
    requestParameters: ListAPIServiceRequest
  ): Promise<runtime.ApiResponse<V1beta1APIServiceList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters.pretty !== undefined) {
      queryParameters['pretty'] = requestParameters.pretty
    }
