 ...
 *
 */
export default class RbacAuthorizationV1alpha1Api extends runtime.BaseAPI {
  /**
   * create a ClusterRole
   */
  async createClusterRoleRaw(
    requestParameters: CreateClusterRoleRequest
  ): Promise<runtime.ApiResponse<V1alpha1ClusterRole>> {
  ...
  ): Promise<runtime.ApiResponse<V1alpha1ClusterRoleBinding>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1alpha1Role>> {
  ...
  ): Promise<runtime.ApiResponse<V1alpha1RoleBinding>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
  ...
  async watchListClusterRole(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1ClusterRoleList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1alpha1ClusterRoleList>>(
      {
        path: `/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles`,
        method: 'GET',
        headers: headerParameters,
  ...
  async listClusterRoleRaw(
    requestParameters: ListClusterRoleRequest
  ): Promise<runtime.ApiResponse<V1alpha1ClusterRoleList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters.pretty !== undefined) {
      queryParameters['pretty'] = requestParameters.pretty
    }
  ...
  async watchListClusterRoleBinding(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1ClusterRoleBindingList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    const queryParameters: runtime.HTTPQuery = { watch: true }
    if (requestParameters.pretty !== undefined) {
    ...
    await this.requestStream<runtime.ItemType<V1alpha1ClusterRoleBindingList>>(
      {
        path: `/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings`,
        method: 'GET',
        headers: headerParameters,
  ...
  async listClusterRoleBindingRaw(
    requestParameters: ListClusterRoleBindingRequest
  ): Promise<runtime.ApiResponse<V1alpha1ClusterRoleBindingList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters.pretty !== undefined) {
      queryParameters['pretty'] = requestParameters.pretty
    }
  ...
  async watchListNamespacedRole(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1RoleList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
    ...
    await this.requestStream<runtime.ItemType<V1alpha1RoleList>>(
      {
        path: `/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles`.replace(
          `{${'namespace'}}`,
          encodeURIComponent(String(requestParameters.namespace))
  ...
  async listNamespacedRoleRaw(
    requestParameters: ListNamespacedRoleRequest
  ): Promise<runtime.ApiResponse<V1alpha1RoleList>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
        'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedRole.'
      )
  ...
  async watchListNamespacedRoleBinding(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1RoleBindingList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
    ...
    await this.requestStream<runtime.ItemType<V1alpha1RoleBindingList>>(
      {
        path: `/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings`.replace(
          `{${'namespace'}}`,
          encodeURIComponent(String(requestParameters.namespace))
  ...
  async listNamespacedRoleBindingRaw(
    requestParameters: ListNamespacedRoleBindingRequest
  ): Promise<runtime.ApiResponse<V1alpha1RoleBindingList>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
        'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedRoleBinding.'
      )
