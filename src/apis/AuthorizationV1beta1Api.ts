 ...
 *
 */
export default class AuthorizationV1beta1Api extends runtime.BaseAPI {
  /**
   * create a LocalSubjectAccessReview
   */
  async createNamespacedLocalSubjectAccessReviewRaw(
    requestParameters: CreateNamespacedLocalSubjectAccessReviewRequest
  ): Promise<runtime.ApiResponse<V1beta1LocalSubjectAccessReview>> {
  ...
  ): Promise<runtime.ApiResponse<V1beta1SelfSubjectAccessReview>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1beta1SelfSubjectRulesReview>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1beta1SubjectAccessReview>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new Error(
