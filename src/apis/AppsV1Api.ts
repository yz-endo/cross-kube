...
export default class AppsV1Api extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<V1DaemonSet>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1Deployment>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1ReplicaSet>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
  ...
  ): Promise<runtime.ApiResponse<V1StatefulSet>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
  ...
  async watchListControllerRevisionForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1ControllerRevisionList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1ControllerRevisionList>>(
      {
  ...
  async listControllerRevisionForAllNamespacesRaw(
    requestParameters: ListControllerRevisionForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1ControllerRevisionList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
  ...
  async watchListDaemonSetForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1DaemonSetList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    const queryParameters: runtime.HTTPQuery = { watch: true }
    if (requestParameters._continue !== undefined) {
    ...
    await this.requestStream<runtime.ItemType<V1DaemonSetList>>(
      {
  ...
  async listDaemonSetForAllNamespacesRaw(
    requestParameters: ListDaemonSetForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1DaemonSetList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
  ...
  async watchListDeploymentForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1DeploymentList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    const queryParameters: runtime.HTTPQuery = { watch: true }
    if (requestParameters._continue !== undefined) {
    ...
    await this.requestStream<runtime.ItemType<V1DeploymentList>>(
      {
  ...
  async listDeploymentForAllNamespacesRaw(
    requestParameters: ListDeploymentForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1DeploymentList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
  ...
  async watchListNamespacedReplicaSet(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1ReplicaSetList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
    ...
    await this.requestStream<runtime.ItemType<V1ReplicaSetList>>(
      {
        path: `/apis/apps/v1/namespaces/{namespace}/replicasets`.replace(
          `{${'namespace'}}`,
          encodeURIComponent(String(requestParameters.namespace))
  ...
  async listNamespacedReplicaSetRaw(
    requestParameters: ListNamespacedReplicaSetRequest
  ): Promise<runtime.ApiResponse<V1ReplicaSetList>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
        'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedReplicaSet.'
      )
  ...
  async watchListNamespacedStatefulSet(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1StatefulSetList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
    ...
    await this.requestStream<runtime.ItemType<V1StatefulSetList>>(
      {
        path: `/apis/apps/v1/namespaces/{namespace}/statefulsets`.replace(
          `{${'namespace'}}`,
          encodeURIComponent(String(requestParameters.namespace))
  ...
  async listNamespacedStatefulSetRaw(
    requestParameters: ListNamespacedStatefulSetRequest
  ): Promise<runtime.ApiResponse<V1StatefulSetList>> {
    if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
      throw new Error(
        'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedStatefulSet.'
      )
