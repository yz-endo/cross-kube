 ...
 *
 */
export default class SchedulingV1alpha1Api extends runtime.BaseAPI {
  /**
   * create a PriorityClass
   */
  async createPriorityClassRaw(
    requestParameters: CreatePriorityClassRequest
  ): Promise<runtime.ApiResponse<V1alpha1PriorityClass>> {
  ...
  async watchListPriorityClass(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1PriorityClassList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1alpha1PriorityClassList>>(
      {
        path: `/apis/scheduling.k8s.io/v1alpha1/priorityclasses`,
        method: 'GET',
        headers: headerParameters,
  ...
  async listPriorityClassRaw(
    requestParameters: ListPriorityClassRequest
  ): Promise<runtime.ApiResponse<V1alpha1PriorityClassList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters.pretty !== undefined) {
      queryParameters['pretty'] = requestParameters.pretty
    }
