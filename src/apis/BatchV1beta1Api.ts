 ...
 *
 */
export default class BatchV1beta1Api extends runtime.BaseAPI {
  /**
   * create a CronJob
   */
  async createNamespacedCronJobRaw(
    requestParameters: CreateNamespacedCronJobRequest
  ): Promise<runtime.ApiResponse<V1beta1CronJob>> {
  ...
  async watchListCronJobForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1beta1CronJobList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1beta1CronJobList>>(
      {
  ...
  async listCronJobForAllNamespacesRaw(
    requestParameters: ListCronJobForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1beta1CronJobList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
