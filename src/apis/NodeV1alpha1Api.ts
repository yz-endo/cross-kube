 ...
 *
 */
export default class NodeV1alpha1Api extends runtime.BaseAPI {
  /**
   * create a RuntimeClass
   */
  async createRuntimeClassRaw(
    requestParameters: CreateRuntimeClassRequest
  ): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
  ...
  async watchListRuntimeClass(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1alpha1RuntimeClassList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1alpha1RuntimeClassList>>(
      {
        path: `/apis/node.k8s.io/v1alpha1/runtimeclasses`,
        method: 'GET',
        headers: headerParameters,
  ...
  async listRuntimeClassRaw(
    requestParameters: ListRuntimeClassRequest
  ): Promise<runtime.ApiResponse<V1alpha1RuntimeClassList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters.pretty !== undefined) {
      queryParameters['pretty'] = requestParameters.pretty
    }
