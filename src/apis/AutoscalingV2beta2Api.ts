 ...
 *
 */
export default class AutoscalingV2beta2Api extends runtime.BaseAPI {
  /**
   * create a HorizontalPodAutoscaler
   */
  async createNamespacedHorizontalPodAutoscalerRaw(
    requestParameters: CreateNamespacedHorizontalPodAutoscalerRequest
  ): Promise<runtime.ApiResponse<V2beta2HorizontalPodAutoscaler>> {
  ...
  async watchListHorizontalPodAutoscalerForAllNamespaces(
    ...
    callback: (
      event: runtime.KubeEvent<runtime.ItemType<V2beta2HorizontalPodAutoscalerList>>
    ) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V2beta2HorizontalPodAutoscalerList>>(
      {
  ...
  async listHorizontalPodAutoscalerForAllNamespacesRaw(
    requestParameters: ListHorizontalPodAutoscalerForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V2beta2HorizontalPodAutoscalerList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
