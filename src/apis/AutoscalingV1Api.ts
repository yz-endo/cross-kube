...
export default class AutoscalingV1Api extends runtime.BaseAPI {
  ...
  async watchListHorizontalPodAutoscalerForAllNamespaces(
    ...
    callback: (event: runtime.KubeEvent<runtime.ItemType<V1HorizontalPodAutoscalerList>>) => void,
    signal?: AbortSignal
  ): Promise<void> {
    ...
    await this.requestStream<runtime.ItemType<V1HorizontalPodAutoscalerList>>(
      {
  ...
  async listHorizontalPodAutoscalerForAllNamespacesRaw(
    requestParameters: ListHorizontalPodAutoscalerForAllNamespacesRequest
  ): Promise<runtime.ApiResponse<V1HorizontalPodAutoscalerList>> {
    const queryParameters: runtime.HTTPQuery = {}
    if (requestParameters._continue !== undefined) {
      queryParameters['continue'] = requestParameters._continue
    }
